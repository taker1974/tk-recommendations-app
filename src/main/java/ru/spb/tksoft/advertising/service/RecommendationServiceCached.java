...
public class RecommendationServiceCached {
    ...
    public boolean isFitsInvest500(final UUID userId) {
        ...
        return transactionService.isUsingProduct(userId, ProductType.DEBIT) &&
                ...
                transactionService.getProductSum(userId, ProductType.SAVING,
                        TransactionType.DEPOSIT) > 1000;
    }
    ...
    public boolean isFitsTopSaving(final UUID userId) {
        ...
        double sumDebit = transactionService.getProductSum(userId, ProductType.DEBIT,
                TransactionType.DEPOSIT);
        double sumSaving = transactionService.getProductSum(userId, ProductType.SAVING,
                TransactionType.DEPOSIT);
        double lim = 50_000;
        boolean cond2 = sumDebit >= lim || sumSaving >= lim;

        double sumDeposit = transactionService.getProductSum(userId, ProductType.DEBIT,
                TransactionType.DEPOSIT);
        double sumWithdraw = transactionService.getProductSum(userId, ProductType.DEBIT,
